...
export const EN_TRANSLATIONS = {
    ...
    aiAnalysisTitle: 'Market Data Analysis',
    aiAnalysisDescription: 'Real-time market data processing with advanced technical analysis and pattern recognition',
    realTimeTitle: 'SEC Filing Analysis',
    realTimeDescription: 'Automated analysis of SEC filings, earnings reports, and corporate announcements',
    portfolioTitle: 'Sentiment Analysis',
    portfolioDescription: 'AI-powered sentiment analysis of news, social media, and market commentary',
    benefitsTitle: 'Benefits',
    dataAccessTitle: 'Risk Assessment',
    dataAccessDescription: 'Comprehensive risk analysis with portfolio optimization and stress testing',
    intelligentTitle: 'Trading Strategies',
    intelligentDescription: 'AI-generated trading strategies with backtesting and execution planning',
    riskManagementTitle: 'Multi-Agent Collaboration',
    riskManagementDescription: 'Specialized AI agents work together to provide holistic financial insights',
