...
export const EN_TRANSLATIONS = {
    ...
    // Glossary
    glossaryPageTitle: 'Financial Glossary',
    glossaryPageDescription: 'Your comprehensive guide to financial terms and concepts. Learn the language of investing and trading.',
    glossaryPageSearchTipPlaceholder: 'Search terms... (e.g., P/E ratio, RSI, dividend)',
    glossaryPageAllCategories: 'All Categories',
    glossaryPageFound: 'Found',
    glossaryPageTermsMatching: 'terms matching',
    glossaryPageShowing: 'Showing',
    glossaryPageTerms: 'terms',
    glossaryPageIn: 'in',
    glossaryPageNoTermsFound: 'No terms found',
    glossaryPageNoTermsFoundSuggestion: 'Try adjusting your search query or selecting a different category.',
    glossaryPageAlsoKnownAs: 'Also known as',
    glossary: 'Glossary',
    glossary_cat_fundamental_analysis_name: 'Fundamental Analysis',
    glossary_cat_fundamental_analysis_description: 'Analysis based on company financials and economic factors',
    glossary_cat_technical_indicators_name: 'Technical Indicators',
    glossary_cat_technical_indicators_description: 'Mathematical calculations based on price and volume data',
    glossary_cat_trading_psychology_name: 'Trading Psychology',
    glossary_cat_trading_psychology_description: 'Behavioral and psychological aspects of trading',
    glossary_cat_general_finance_name: 'General Finance',
    glossary_cat_general_finance_description: 'Basic financial concepts and terminology',
    glossary_cat_market_metrics_name: 'Market Metrics',
    glossary_cat_market_metrics_description: 'Key performance indicators for stocks and markets',
    glossary_cat_risk_management_name: 'Risk Management',
    glossary_cat_risk_management_description: 'Concepts related to managing investment risk',
    glossary_cat_corporate_finance_name: 'Corporate Finance',
    glossary_cat_corporate_finance_description: 'Company financial structure and operations',
    glossaryTooltipClickDefinition: 'Click for full definition',
    glossaryTooltipDefinition: 'Definition',
    glossaryTooltipExample: 'Example',
    glossaryTooltipAlsoKnownAs: 'Also known as',
    glossaryTooltipViewInGlossary: 'View in glossary',
} as const;
